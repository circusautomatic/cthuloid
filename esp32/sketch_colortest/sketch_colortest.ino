...
#define DATA_PIN 27
// it really wants to use GRB apparently, RGB won't work
...
//  cmdPWMPins();
  ...
  for(uint8_t i=0; i < NUM_LEDS; i++){
    leds[i].setRGB(0, 0, 100); FastLED.show();
    }
//  FastLED.show();
...
void loop() {
  CmdMgr.readSerial();
  leds[01].setRGB(200, 0, 0); FastLED.show(); delay(300);
  leds[01].setRGB(100, 100, 0); FastLED.show(); delay(300);
